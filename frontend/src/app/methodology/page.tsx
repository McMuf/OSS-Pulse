...
async function getMethodology(apiBase: string): Promise<Methodology | null> {
  try {
    const res = await fetchWithTimeout(`${apiBase}/methodology`, { cache: "no-store" });
...
export default async function MethodologyPage() {
  ...
  const methodology = await getMethodology(apiBase);
